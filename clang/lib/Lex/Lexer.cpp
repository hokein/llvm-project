...
static SourceLocation getBeginningOfFileToken(SourceLocation Loc,
                                              ...
                                              const LangOptions &LangOpts) {
  assert(Loc.isFileID());
  std::pair<FileID, SourceLocation::UIntTy> LocInfo = SM.getDecomposedLoc(Loc);
...
SourceLocation Lexer::GetBeginningOfToken(SourceLocation Loc,
  ...
  auto FileLocInfo = SM.getDecomposedLoc(FileLoc);
  auto BeginFileLocInfo =
...
static CharSourceRange makeRangeFromFileLocs(CharSourceRange Range,
  ...
  FileID FID;
  SourceLocation::UIntTy BeginOffs;
...
StringRef Lexer::getSourceText(CharSourceRange Range,
  ...
  // Break down the source location.
  auto beginInfo = SM.getDecomposedLoc(Range.getBegin());
...
StringRef Lexer::getImmediateMacroName(SourceLocation Loc,
  ...
  auto ExpansionInfo = SM.getDecomposedLoc(Loc);
