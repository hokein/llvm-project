...
bool Sema::diagnoseArgDependentAttributeIfAttrs(const FunctionDecl *Function,
  ...
  //     // EvaluateWithSubstitution only cares about the position of each
  //     Function->dump();
  //     // if (!A->getCond()->EvaluateWithSubstitution(Result, Context, Function,
  //     //                                             Args, ThisArg))
  //     //   return false;

  //     bool Result;
  //     if (!A->getCond()->EvaluateAsBooleanCondition(Result, Context))
  //       return false;
  //     llvm::errs() << "success fully?" << Result << "!\n";
  //     // llvm::errs() << "success full? "
